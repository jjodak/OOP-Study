/*
 * 파일 설명: 수업 실습 예제입니다. 여러 객체를 만들어 실제 게임 흐름을 실행하는 클래스입니다.
...
// 클래스 game: 수업 실습 예제입니다. 여러 객체를 만들어 실제 게임 흐름을 실행하는 클래스입니다.
public class game {
    // main(): 프로그램 실행 시작점입니다.
    public static void main(String[] args) {
        hero hero = new hero("준혁",1);
        zombie z1 = new zombie("좀비 1", 10);
        zombieking zk = new zombieking("좀비 킹", 20);
        ...
        while(true){
            ...
            System.out.println(z1.pos);
            System.out.println(zk.pos);

            if(hero.pos == 20){
                System.out.println("목적지 도착!!");
                break;
            } else if (hero.pos == z1.pos || hero.pos == zk.pos) {
